...
ALTER TABLE public.trabajadores
  ...
  ADD COLUMN IF NOT EXISTS ultima_revision_salarial DATE;
...
DROP POLICY IF EXISTS "alertas_own" ON public.alertas;
CREATE POLICY "alertas_own" ON public.alertas FOR ALL
...
-- 4. Función generadora de alertas
